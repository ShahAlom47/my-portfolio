...
const AboutMe = () => {
    ...
    const text = `Welcome to my portfolio! I am Shah Alom, a Creative Front-End Developer with a passion for building user-friendly and innovative websites and applications. Web development is not just a profession for me it's a dream, a passion, and an emotion that drives me every day. With a strong foundation in  Tailwind CSS, JavaScript,TypeScript, React.js, Next.Js, Node.js, Express.js, Firebase, and MongoDB, I bring my creative visions to life through clean, efficient, and engaging code. My journey into web development started with a fascination for technology and design, it has evolved into a deep-seated love for creating beautiful and functional digital experiences. Every project I undertake is a new opportunity to learn, grow, and push the boundaries of what's possible. From concept to completion, I pour my heart and soul into every line of code, ensuring that the end product is not only visually appealing but also seamlessly functional. Thank you for visiting my portfolio. I look forward to the possibility of collaborating on exciting projects and bringing more of my dreams to life through the power of web development. `;
